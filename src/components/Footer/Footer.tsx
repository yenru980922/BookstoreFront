          ...
          <div className="row">
            <div className="col-lg-3 col-md-4 col-sm-6 col-12">
              <div className="logo-content">
                ...
                <h3 className="text-white">Want monthly book recommendations?</h3>
                <div className="footer-button">
                  <a className="get_started text-decoration-none" href="./contact.html">Follow Us</a>
                  <a className="image-button text-decoration-none" href="./contact.html">
              ...
              <div className="links">
                ...
                <div className="lower-content">
                  ...
                  <div className="content">
                    ...
                    <a className="text-size-16 mb-0 text-decoration-none" href="tel:03-8868886">03-8868886</a>
                  </div>
                </div>
                <div className="lower-content">
                  <figure className="icon">
                  ...
                  <div className="content">
                    ...
                    <p className="text text-size-16">桃園市中壢區新生路二段421號</p>
                  </div>
                </div>
                <div className="lower-content">
                  ...
                  <div className="content">
                    ...
                    <a href="mailto:used.books.a.new.lease.of.life@gmail.com" className="text-size-16 mb-0 text-decoration-none">used.books.a.new.lease.of.life@gmail.com</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-4 col-12 d-lg-block d-none" style={{paddingLeft:"108px"}}>
              <div className="info">
                <h4 className="text-white">Subscribe to Our Newsletter:</h4>
                <form method="POST">
                  <div className="form-group">
                    <input type="text" className="form_style" placeholder="Enter Your Email Address:" name="email" />
                    <button type="submit">
                ...
                <ul className="list-unstyled mb-0">
                  <li className="text"><FontAwesomeIcon icon={faCheck} /> Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse.</li>
                </ul>
                <div className="social-icons position-relative">
                <ul className="list-unstyled mb-0 p-0 position-absolute">
                <li>
                  <a href="#" className="text-decoration-none">
                    <FontAwesomeIcon icon={faFacebookF} className="social-networks" />
                  </a>
                </li>
                <li>
                  <a href="#" className="text-decoration-none">
                    <FontAwesomeIcon icon={faTwitter} className="social-networks" />
                  </a>
                </li>
                            </ul>
</div>
...
<p className="text-size-14">Copyright © 2024 Used books-a new lease of life All rights reserved.</p>
</div>
</div>
</div>
</div>
